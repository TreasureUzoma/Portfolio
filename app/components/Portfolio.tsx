          ...
          <div className="my_fixed_width">
            ...
            <div className="grid place-items-center my-5 gap-6 md:grid-cols-3 md:gap-8">
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">GapPay Website</p>
                  <p className={pStyle}>
                    Fintech landing page streamlining transactions with secure
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">SecretSender</p>
                  <p className={pStyle}>
                    Landing page for a web app for getting anonymous replies on
                  ...
                  <div className={tagsWrapperStyle}>
                    ...
                    <span className="px-3">•</span>
                    <span className={tagStyle}>Framer Motion</span>
                  </div>
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">SecretSender PWA</p>
                  <p className={pStyle}>
                    Mobile-responsive web app for receiving anonymous replies on
                    the go just like ngl.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>ReactJs</span>
                    <span className="px-3">•</span>
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">StreakMaster</p>
                  <p className={pStyle}>
                    Landing page for a habit tracker PWA app promoting goal
                    achievement.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>ReactJs</span>
              ...
              <div className={divStyle}>
                <div className="py-5">
                  <p className="text-xl text-white">StreakMaster PWA</p>
                  <p className={pStyle}>
                    Cloud-based habit tracker and streak & progress counter web
                    app
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>ReactJs</span>
              ...
              <div className={divStyle}>
                <div>
                  ...
                  <p className={pStyle}>
                    Gemini powered AI Chatbot for task management and
                    assistance.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>ReactJS</span>
              ...
              <div className={divStyle}>
                <div>
                  ...
                  <p className={pStyle}>
                    Convert’s long cumbersome links to shorter links
                    efficiently.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>JavaScript</span>
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">GitHub Roast AI</p>
                  <p className={pStyle}>
                  ...
                  <div className={tagsWrapperStyle}>
                    ...
                    <span className="px-3">•</span>
                    <span className={tagStyle}>TailwindcssCSS</span>
                    <span className="px-3">•</span>
                    <span className={tagStyle}>ReactJs</span>
                  </div>
                  <div className="flex justify-center items-center gap-3">
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">Recipe Chat Bot</p>
                  <p className={pStyle}>
                    Conversational Chatbot for providing 1000+ recipes and
              ...
              <div className={divStyle}>
                <div>
                  ...
                  <p className={pStyle}>
                    A web design agency portfolio showcasing modern, responsive
                    design expertise.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>JavaScript</span>
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">Password Generator</p>
                  <p className={pStyle}>
                    Secure password generator tool go for generating secure
                    memorable passwords.
                  </p>
                  <div className={tagsWrapperStyle}>
                    <span className={tagStyle}>ReactJs</span>
              ...
              <div className={divStyle}>
                <div>
                  <p className="text-xl text-white">Jokes Generator</p>
                  <p className={pStyle}>
                    Random dry jokes generator delivering humor on a click of a
                    button.
                  </p>
                  <div className={tagsWrapperStyle}>
